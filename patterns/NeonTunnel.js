...
export class NeonTunnel extends PatternBase {
     ...
     */
    _generateIrregularPolygon(numVertices, depth, scale, rotation, color, thickness, randomnessFactor = 0.3) {
        const vertices = [];
        const angleStep = (Math.PI * 2) / numVertices;
    ...
    _mapAudioToVisuals(audioData, beatData) {
        ...
        if (audioData.midEnergy > 0.3) { // Lower threshold for more reactivity
